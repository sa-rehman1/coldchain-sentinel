...
export class MockControlTowerDataSource implements ControlTowerDataSource {
  ...
  async getHealth(): Promise<PlatformHealth> { return Promise.resolve({ api: 'healthy', ai: 'healthy', provider: 'groq', providerConfigured: false, liveCallsEnabled: false, fallbackAvailable: true, qdrant: 'ready' }); }
